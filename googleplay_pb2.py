...
_SEARCHCLUSTERRESPONSE = _descriptor.Descriptor(
  name='SearchClusterResponse',
  full_name='SearchClusterResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='info', full_name='SearchClusterResponse.info', index=0,
      number=1, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='preFetch', full_name='SearchClusterResponse.preFetch', index=1,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHPREFETCH = _descriptor.Descriptor(
  name='SearchPreFetch',
  full_name='SearchPreFetch',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='SearchPreFetch.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='response', full_name='SearchPreFetch.response', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='etag', full_name='SearchPreFetch.etag', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ttl', full_name='SearchPreFetch.ttl', index=3,
      number=4, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='softTtl', full_name='SearchPreFetch.softTtl', index=4,
      number=5, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHRESPONSEWRAPPER = _descriptor.Descriptor(
  ...
  full_name='SearchResponseWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wrapper', full_name='SearchResponseWrapper.wrapper', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHCLUSTERWRAPPER = _descriptor.Descriptor(
  name='SearchClusterWrapper',
  full_name='SearchClusterWrapper',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='wrapper', full_name='SearchClusterWrapper.wrapper', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHCLUSTERWRAPPER2 = _descriptor.Descriptor(
  name='SearchClusterWrapper2',
  full_name='SearchClusterWrapper2',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster', full_name='SearchClusterWrapper2.cluster', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEARCHCLUSTERRESPONSE.fields_by_name['preFetch'].message_type = _SEARCHPREFETCH
_SEARCHPREFETCH.fields_by_name['response'].message_type = _SEARCHRESPONSEWRAPPER
_SEARCHRESPONSEWRAPPER.fields_by_name['wrapper'].message_type = _SEARCHCLUSTERWRAPPER
_SEARCHCLUSTERWRAPPER.fields_by_name['wrapper'].message_type = _SEARCHCLUSTERWRAPPER2
_SEARCHCLUSTERWRAPPER2.fields_by_name['cluster'].message_type = _SEARCHCLUSTER
...
DESCRIPTOR.message_types_by_name['SearchClusterResponse'] = _SEARCHCLUSTERRESPONSE
DESCRIPTOR.message_types_by_name['SearchPreFetch'] = _SEARCHPREFETCH
DESCRIPTOR.message_types_by_name['SearchResponseWrapper'] = _SEARCHRESPONSEWRAPPER
DESCRIPTOR.message_types_by_name['SearchClusterWrapper'] = _SEARCHCLUSTERWRAPPER
DESCRIPTOR.message_types_by_name['SearchClusterWrapper2'] = _SEARCHCLUSTERWRAPPER2
...
SearchClusterResponse = _reflection.GeneratedProtocolMessageType('SearchClusterResponse', (_message.Message,), dict(
  DESCRIPTOR = _SEARCHCLUSTERRESPONSE,
  __module__ = 'googleplay_pb2'
  # @@protoc_insertion_point(class_scope:SearchClusterResponse)
  ))
_sym_db.RegisterMessage(SearchClusterResponse)

SearchPreFetch = _reflection.GeneratedProtocolMessageType('SearchPreFetch', (_message.Message,), dict(
  DESCRIPTOR = _SEARCHPREFETCH,
  __module__ = 'googleplay_pb2'
  # @@protoc_insertion_point(class_scope:SearchPreFetch)
  ))
_sym_db.RegisterMessage(SearchPreFetch)
...
SearchResponseWrapper = _reflection.GeneratedProtocolMessageType('SearchResponseWrapper', (_message.Message,), dict(
  ...
  __module__ = 'googleplay_pb2'
  # @@protoc_insertion_point(class_scope:SearchResponseWrapper)
  ))
_sym_db.RegisterMessage(SearchResponseWrapper)

SearchClusterWrapper = _reflection.GeneratedProtocolMessageType('SearchClusterWrapper', (_message.Message,), dict(
  DESCRIPTOR = _SEARCHCLUSTERWRAPPER,
  __module__ = 'googleplay_pb2'
  # @@protoc_insertion_point(class_scope:SearchClusterWrapper)
  ))
_sym_db.RegisterMessage(SearchClusterWrapper)

SearchClusterWrapper2 = _reflection.GeneratedProtocolMessageType('SearchClusterWrapper2', (_message.Message,), dict(
  DESCRIPTOR = _SEARCHCLUSTERWRAPPER2,
  __module__ = 'googleplay_pb2'
  # @@protoc_insertion_point(class_scope:SearchClusterWrapper2)
  ))
_sym_db.RegisterMessage(SearchClusterWrapper2)
